...
Option: manufacturing standard, machanical property, manufacturing process, material, engineering feature, process parameter, machine or equipment, application, process characterization, enabling technology, biomedical, concept or principle
Input: sudden change of temperature or osmotic pressure and invasion of various pathogens .
Output:
process parameter: temperature; concept or principle: pressure

Task: Please list all entity words in the text that fit the category. Output format is \"type1: word1; type2: word2\". 
Option: geographical social political, organization, person, location, facility, vehicle, weapon
Input: When the gross national product per capita reached 3000 US dollars in Japan , South Korea and Taiwan , etc . , environmental protection awareness generally rose , and all began to obviously increase usage of electricity generated by liquefied natural gas .
Output:
geographical social political: US; geographical social political: Japan; geographical social political: South Korea; geographical social political: Taiwan; geographical social political: etc; geographical social political: all
...
Input: Each time he arrived at the anticoagulation clinic after his BCG therapy, his INR was supratherapeutic, except after his fourth treatment (INR of 2.5), which can be explained by residual effects from the phytonadione he received a week earlier.
Output:
adverse event: from 
...
Input: Although they had complex medical problems , the high serum concentrations of ampicillin at the time of seizures without their recurrence after discontinuing the antibiotic suggest that the seizures were related to the ampicillin therapy .
Output:
adverse effect: seizures, ampicillin; adverse effect: seizures, ampicillin

Task: Given a phrase that describes the relationship between two words, extract the words and the lexical relationship between them. Output format should be \"relation1: word1, word2; relation2: word3, word4\". 
Option: Organization based in, Located in, Live in, Work for, Kill
Input: The ` ` poison pill , ' ' ruled illegal in November by U.S. District G. Ernest Tidwell , would become effective after a shareholder had acquired 10 percent of the outstanding stock .
Output:
Live in: G. Ernest Tidwell, U.S.
