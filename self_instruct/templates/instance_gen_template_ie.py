...
4.
Instruction:
For the specified event type and trigger, identify and report the roles of all the related arguments. 
Format:
Present the results in the format of "name1: role1; name2: role2". 
...
6.
Instruction:
Locate and present all entity words associated with a given category within the provided text.
Format:
Output format is "type1: word1; type2: word2". 
Option: GENE
Input:
